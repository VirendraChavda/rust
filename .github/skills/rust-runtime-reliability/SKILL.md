...
## Workflow
1. Identify runtime boundaries and state transitions.
2. Validate retry, timeout, cancellation, and idempotency behavior.
3. Require deterministic tests and failure-mode coverage.
4. Run reliability and full CI checks.
